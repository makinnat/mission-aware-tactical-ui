...
const Products = () => {
  ...
  return <div className="min-h-screen w-full">
      ...
      backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('/lovable-uploads/dc67d67a-fb82-4800-96a6-3ca6bea85908.png')`
    }}>
        {/* Dark Overlay */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="military-card bg-muted/50 border-[#6C6846] hover:border-scarlet-red transition-all duration-300 group h-full">
              <CardContent className="p-8 text-center h-full flex flex-col">
                ...
                <Link to="/products/sleep-plug" className="mt-auto">
                  <Button className="btn-olive-outline w-full">
                    VIEW SLEEPPLUG
                  </Button>
                </Link>
            ...
            <Card className="military-card bg-muted/50 border-[#6C6846] hover:border-scarlet-red transition-all duration-300 group h-full">
              <CardContent className="p-8 text-center h-full flex flex-col">
                ...
                <Link to="/products/swim-plug" className="mt-auto">
                  <Button className="btn-olive-outline w-full">
                    VIEW SWIMPLUG
                  </Button>
                </Link>
