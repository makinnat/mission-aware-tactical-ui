    ...
    <div className="min-h-screen w-full">
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="heading-tactical text-primary text-4xl md:text-6xl mb-8 leading-tight">
            REVOLUTIONIZING HEARING PROTECTION FOR MISSION-CRITICAL ENVIRONMENTS
          </h1>
          
          <p className="subheading-tactical text-secondary text-xl md:text-2xl mb-12 max-w-4xl mx-auto">
