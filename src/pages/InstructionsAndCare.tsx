...
const InstructionsAndCare = () => {
  ...
  return (
    <div className="min-h-screen bg-combat-black text-signal-white font-inter">
      ...
      {/* Hero Section */}
      <section ref={heroRef} className={`pt-24 pb-16 transition-all duration-1000 bg-cover bg-center bg-no-repeat relative ${heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('/lovable-uploads/585fd23f-f43a-49ab-ab65-676067bcc1e1.png')`}}>
