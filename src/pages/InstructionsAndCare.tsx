...
const InstructionsAndCare = () => {
  ...
  return (
    <div className="min-h-screen bg-combat-black text-signal-white font-inter">
      ...
      {/* Hero Section */}
      <section ref={heroRef} className={`pt-24 pb-32 min-h-[70vh] transition-all duration-1000 bg-cover bg-center bg-no-repeat relative ${heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), url('/lovable-uploads/52689a72-00c0-4281-96b0-2054166b50f2.png')`}}>
